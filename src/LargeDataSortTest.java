...
public class LargeDataSortTest {
    ...
    static File file = new File("/Users/apple/Downloads/sort/" + File.separator + "dataTest" + File.separator + "data.txt");
    static File file1 = new File("/Users/apple/Downloads/sort/" + File.separator + "dataTest" + File.separator + "dataSorted.txt");
    ...
    public static void separateFile() throws IOException {
        ...
        for (int i = 0; i < 20; i++) {
            fw = new FileWriter("/Users/apple/Downloads/sort/" + File.separator + "dataTest" + File.separator + "data" + i + ".txt");
    ...
    public static void everySingleFileSort() throws Exception {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            String path = "/Users/apple/Downloads/sort/" + File.separator + "dataTest" + File.separator + "data" + i + ".txt";
